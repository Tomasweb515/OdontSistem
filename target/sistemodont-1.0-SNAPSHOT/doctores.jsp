                ...
                <form class="user" id="form" method="post">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <input type="text" class="form-control" id="doc_nombre" name="doc_nombre" placeholder="Nombre">
                            <small id="error-nombre" class="error-msg" style="color: red; display: none;"></small>
                        </div>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="doc_apellido" name="doc_apellido" placeholder="Apellido">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <input type="text" class="form-control" id="doc_telefono" name="doc_telefono" placeholder="Teléfono">
                            <small id="error-telefono" class="error-msg" style="color: red; display: none;"></small>
                        </div>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="doc_ci" name="doc_ci" placeholder="Cédula">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <input type="text" class="form-control" id="doc_titulo" name="doc_titulo" placeholder="Título">
                            <small id="error-titulo" class="error-msg" style="color: red; display: none;"></small>
                        </div>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="doc_matricula" name="doc_matricula" placeholder="Matrícula">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-5 mb-0">
                            ...
                            <select class="js-states form-control" id="idespecialidad" name="idespecialidad"  >
    ...
    <div class="card shadow mb-4">
            ...
            <div class="table-responsive">
                <div class="contenedor">
                    <div class="derecha">                               <input type="text" class="form-control form-control-user" id="buscar" onkeyup="buscar()" placeholder="Buscar en tabla" title="Empieza a escribir para buscar">
                        ...
                        <a type="button" class="fa fa-print" href="rpaciente_6.jsp"></a>
       ...
       $("#multiple").select2({
        ...
        <script>
            ...
            function rellenaredit(a, b, c, f, e, d, r, g,k) {
                $("#iddoctor").val(a);
                $("#doc_nombre").val(b);
                $("#doc_apellido").val(c);
                $("#doc_telefono").val(f);
