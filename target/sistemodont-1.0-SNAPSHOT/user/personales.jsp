...
<div class="card-body p-0">
    ...
    <div class="form-group row">
        <div class="col-sm-6 mb-3 mb-sm-0">
            <input type="text" class="form-control form-control-user" id="per_nombre" name="per_nombre" placeholder="Nombre">
            <small id="error-msg-nombre" style="color: red; display: none;">Ponlo bien papu</small>
        </div>
        <div class="col-sm-6">
            <input type="text" class="form-control form-control-user" id="per_apellido" name="per_apellido" placeholder="Apellido">
            <small id="error-msg-apellido" style="color: red; display: none;">Ponlo bien papu</small>
        </div>
    </div>
    <div class="form-group row">
        <div class="col-sm-6 mb-3 mb-sm-0">
            <input type="text" class="form-control form-control-user" id="per_telefono" name="per_telefono" placeholder="Teléfono">
            <small id="error-msg-telefono" style="color: red; display: none;">Ponlo bien papu</small>
        </div>
        <div class="col-sm-6">
            <input type="text" class="form-control form-control-user" id="per_ci" name="per_ci" placeholder="Cédula">
            <small id="error-msg-ci" style="color: red; display: none;">Ponlo bien papu</small>
        </div>
    </div>
    <div class="form-group row">
        <div class="col-sm-6 mb-3 mb-sm-0">
            <input type="email" class="form-control form-control-user" id="per_correo" name="per_correo" placeholder="Correo electrónico">
        ...
        <div class="col-sm-6">
            <div class="dropdown mb-4">
                <div class="col-sm-6">
                    <div class="form-group row">
                        <label for="ciudad">Persona</label>
