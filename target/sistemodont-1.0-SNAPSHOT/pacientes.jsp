...
// Usa false para no crear una nueva sesión si no existe
%>
...
<div class="card-body p-0">
    ...
    <div class="form-group row">
        <div class="col-sm-6 mb-3 mb-sm-0">
            <input type="text" class="form-control" id="pa_nombre" name="pa_nombre" placeholder="Nombre">
            <small id="error-msg-nombre" style="color: red; display: none;">Nombre debe empezar con mayúscula y tener al menos 3 letras.</small>
        </div>
        <div class="col-sm-6">
            <input type="text" class="form-control" id="pa_apellido" name="pa_apellido" placeholder="Apellido">
    ...
    <div class="form-group row">
        <div class="col-sm-6 mb-3 mb-sm-0">
            <input type="text" class="form-control" id="pa_telefono" name="pa_telefono" placeholder="Teléfono">
            <small id="error-msg-telefono" style="color: red; display: none;">Teléfono debe contener solo números.</small>
        </div>
        <div class="col-sm-6">
            <input type="text" class="form-control" id="pa_ci" name="pa_ci" placeholder="Cédula">
            <small id="error-msg-ci" style="color: red; display: none;">Cédula debe contener solo números.</small>
        </div>
    </div>
    <div class="form-group row">
        <div class="col-sm-6">
            <input type="email" class="form-control" id="pa_correo" name="pa_correo" placeholder="Correo electrónico">
...
<div class="contenedor">
  <div class="derecha">                               <input type="text" class="form-control form-control-user" id="buscar" onkeyup="buscar()" placeholder="Buscar en tabla" title="Empieza a escribir para buscar">
                                    ...
                                    <a type="button" href="rpaciente.jsp" class="fa fa-print"></a>
...
$("#eliminaregistro").on("click", function() {
    ...
    $.ajax({
       ...
       $("#impri").on("click", function() {
    $.ajax({
        data: { listar: "imprimirpad"},
        url: 'rpaciente.jsp',
        type: 'post',
        success: function(response) {
            $("#mensaje").html(response);
