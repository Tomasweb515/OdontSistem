...
<input data-modal="myModa2" class="boton" height="20px" id="myBtn2" >
...
<input data-modal="myModa11" height="20px" class="boton"  type="button" id="myBtn1" value="Abrir Modal 1">

<div id="myModa11" class="modal">
  <div class="modal-content">
    <span class="close">&times;</span>
...
<input data-modal="myModa13" class="boton" height="20px" type="button" id="myBtn13" value="Abrir Modal 1">

<div id="myModa13" class="modal">
  <div class="modal-content">
    <span class="close">&times;</span>
    <p>Detección de fugas eléctricas con meghóme3nes eléctricas en general, cableados, mediciones eléctricas, tableros thermomagnéticas, balanceos de carga, instalaciones de MT,BT. Protocolos de mediciones eléctricas.</p>
  <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">NO</button>
                <button type="button" class="btn btn-primary" data-dismiss="modal" id="delcompra">SI</button>
            </div>
...
<style>
  ...
  left: 30%;
    ...
    #myBtn1{
    background-image:url(dientes/48.jpg);
   height: 100px;
         width: 100px;
