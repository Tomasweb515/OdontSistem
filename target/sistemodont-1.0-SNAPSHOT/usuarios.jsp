...
<div class="card-body p-0">
            ...
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control" id="usu_nombre" name="usu_nombre" placeholder="Nombre">
                    <small id="error-msg-nombre" class="error-msg">El nombre debe empezar con mayúscula y tener al menos 3 letras.</small>
                </div>
                <div class="col-sm-6">
                    <input type="password" class="form-control" id="usu_clave" name="usu_clave" placeholder="Clave">
            ...
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control" id="usu_estado" name="usu_estado" placeholder="Estado">
                    <small id="error-msg-estado" class="error-msg">El estado debe contener solo letras y espacios.</small>
                </div>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="usu_tipo" name="usu_tipo" placeholder="Tipo">
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <select class="js-states form-control" id="idpersonal" name="idpersonal">
...
<div class="contenedor">
  <div class="derecha">                               <input type="text" class="form-control form-control-user" id="buscar" onkeyup="buscar()" placeholder="Buscar en tabla" title="Empieza a escribir para buscar">
                                                                        ...
                                                                        <a type="button" class="fa fa-print" href="rpaciente_3.jsp"></a>
