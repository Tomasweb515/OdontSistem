 ...
 function llenado() {
  ...
  function sumador() {
    ...
    $.ajax({
        ...
        type: 'post',
        beforeSend: function () {
            // Puedes añadir código aquí si es necesario para antes de enviar la solicitud
        },
        success: function (response) {
            // Aquí se manejan los valores devueltos por el servidor
...
$("#doc_ci").val("");
 ...
 $("#tercompra").click(function () {
  ...
  $("#final-compra").click(function () {
    ...
    var prueba = <% out.print(prueba); %>; // Obtén el valor de prueba dinámicamente
    ...
    $.ajax({
        ...
        type: 'post',
        beforeSend: function () {
            // Puedes añadir código aquí si es necesario antes de enviar la solicitud
        },
        success: function (response) {
